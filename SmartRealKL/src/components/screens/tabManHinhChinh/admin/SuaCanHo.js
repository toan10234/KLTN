...
import {ActionSuacanHo} from '../../../../redux/actions';
import { connect } from 'react-redux'

 class SuaCanHo extends Component {
   
    constructor(props){
        super(props);
        this.state={tencanho:this.props.tencanho,hinhanh:this.props.hinhanh,thongtin:this.props.thongtin,giatien:this.props.giatien,diachi:this.props.diachi,dientich:this.props.dientich,
        chieudai:this.props.chieudai,chieurong:this.props.chieurong,
        sotang:this.props.sotang,
        phongngu:this.props.phongngu,chodexe:this.props.chodexe};
    }
        ...
        return (
            <ScrollView style={styles.container}>
                 <View style={styles.container}>
                    <Text style={styles.textheader}> Update apartment </Text>
                   ...
                   <TouchableOpacity    style={styles.button}
                        onPress={() => {
                             const {tencanho,hinhanh,thongtin,giatien,diachi,dientich,chieudai,chieurong,
                              ...
                              this.props.onSuaCanHo({idcanho,token,tencanho,hinhanh,thongtin,giatien,diachi,dientich,chieudai,chieurong,sotang,phongngu,chodexe});
...
const mapStateToProps = (state) => ({
    ...
    tencanho:state.canHoReducers.tencanho,hinhanh:state.canHoReducers.hinhanh,thongtin:state.canHoReducers.thongtin,giatien:state.canHoReducers.giatien,
    diachi:state.canHoReducers.diachi,dientich:state.canHoReducers.dientich,
    chieudai:state.canHoReducers.chieudai,chieurong:state.canHoReducers.chieurong,sotang:state.canHoReducers.sotang,phongngu:state.canHoReducers.phongngu,chodexe:state.canHoReducers.chodexe,
})


const mapDispatchToProps=(dispatch)=>{
    return{
        onSuaCanHo:(inputSuaCanHo)=>{
            dispatch(ActionSuacanHo(inputSuaCanHo))
        }
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(SuaCanHo)
